...
<<PlotClimatology, echo=FALSE, dependson='ClimatologyRMSE', fig.cap = "RMSE vs. $k$", fig.height=4>>=
...
<<gamlssTrendPlot, echo=FALSE, fig.cap = "Trend uncertainty (gamlss)", fig.height = 4>>=
...
<<echo=FALSE, fig.height=4, fig.cap="Projection 1. January">>=
