...
<<TGbaseplot2016, echo = FALSE, cache = TRUE, dependson=c('LoadData', 'AnnualMeans', 'GamlssTrend2016', 'ClimateNormals', 'Scenarios', 'Projection2016', 'ScenarioEnvelopes')>>=
...
<<TGplot2016, fig.cap = "Base plot plus projection on 5. May 2017", fig.height=4, echo = FALSE, cache = TRUE, dependson=c('LoadData', 'AnnualMeans', 'GamlssTrend2016', 'ClimateNormals', 'Scenarios', 'Projection2016', 'ScenarioEnvelopes', 'TGbaseplot2016')>>=
